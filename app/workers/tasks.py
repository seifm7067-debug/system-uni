...
def process_background_notification(recipient: str, subject: str, body: str) -> dict[str, Any]:
...
def process_async_report(report_type: str, target_id: int) -> dict[str, Any]:
    logger.info("[WORKER] Processing async report of type '%s' for ID %d", report_type, target_id)
    return {
        "status": "completed",
